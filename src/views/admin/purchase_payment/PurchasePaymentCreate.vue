                      ...
                      <div class="flex justify-between w-full">
                        <div class="flex flex-col text-left">
                          <span class="font-bold"
                            >{{ i.code }} - {{ i.supplier?.name }}</span
                          >
                          <span
                            v-if="i.details?.[0]?.purchaseOrder?.code"
                ...
                <FormControl>
                  <div class="relative">
                    ...
                    <Input
                      ...
                      @update:model-value="
                        (val) => (localAmount = formatNumberInput(String(val)))
                      "
          ...
          <div v-if="selectedInvoice" class="mt-8 pt-8 border-t space-y-6">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-8">
              ...
              <div class="space-y-3">
                ...
                >
                  <History class="h-4 w-4" /> {{ fields.balanceInfo }}
                </h3>
                <div class="space-y-2 text-sm">
                  ...
                  <div
                    v-if="selectedInvoice.details?.[0]?.purchaseOrder"
                    class="pt-2"
                  >
                    <p class="text-xs text-orange-600 font-medium">
                      * {{ purchaseOrderLabels.name }} #{{
                      ...
                      <span
                        v-if="
                          selectedInvoice.details[0].purchaseOrder.totalLine -
                            selectedInvoice.details[0].purchaseOrder
                              .totalCloseLine >
                          0
                        "
                      >
              ...
              <div
                class="bg-muted/30 p-6 rounded-xl border border-muted-foreground/10 flex flex-col justify-center items-center text-center"
              >
